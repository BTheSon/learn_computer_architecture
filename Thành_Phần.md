...
- Gồm 3 thành phần:
    1. **Kiến trúc phần mềm của máy tính**: tập lệnh, dạng lệnh và kiểu định vị

    2. **Tổ chức của máy tính**: cấu trúc bên trong của bộ xử lý, bus, bộ nhớ

    3. **Lắp ráp phần cứng**: việc lắp ráp một máy tính dùng các linh kiện điện tử và các bộ phận phần cứng cần thiết.
...
# Các lựa chọn vị trí các toán hạng
